    ...
    <div className="p-4">
       <form className='m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white' onSubmit={handleSubmit}>
        ...
        <select className='bg-slate-200 p-1 my-1' id='category' name='category' onChange={handleOnChange} value={data.category}>
          ...
          <option value={"Gradient Sunglasses"}>Gradient Sunglasses</option>
          <option value={"Photochromic Sunglasses"}>Aviator Sunglasses</option>
          ...
          <option value={"Driving Sunglasses"}>Driving Sunglasses</option>
          <option value={"Safety Sunglasses"}>Safety Sunglasses</option>
        </select>
